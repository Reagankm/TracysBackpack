  ...
  <div class="row no-gutters" id="primary">
    <main id="content" class="col-sm-7 col-sm-offset-1" role="main">
      <article class="post">
        ...
        <header>
          <h2>Flying 2,400 miles to see Hamilton</h2>
          <div class="post-details">
            <h3>Tracy Middlebrook
              <time>April 13, 2016</time></h3>
          </div>
        </header><!-- post header -->

        <div class="post-image">
          <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/ticketmaster.jpg" />
        </div><!-- post image -->


        <div class="post-text">
          <p>Early Oct 2015, after streaming the Hamilton cast recording non stop (NON STOP!) for two weeks after it’s late Sept release, I had a revelation. I am a grown ass woman, in charge of my own finances and scheduling. And so it’s actually possible for me to buy tickets to a Broadway show and go to Broadway to see it, hopefully still with much of the principal cast. And so I did! And I’ve been counting the days for the last 6 months. (Also, it’s totally ridiculous that I did this, having already had my March New Orleans girls weekend booked, but eff it, I was not throwing away my shot! (If you’re wondering whether I’ll continue quoting Hamilton, probably. I’m really Helpless about it….and yes, I know that one is a stretch)).
            ...
            Friday evening, we wandered over to Greenwich Village to meet up with Joseph (high school pal and fellow musical theatre nerd. He hipped me to Hamilton a year ago, during it’s off broadway stages) and his del</p>
        </div>
      </article>
      ...
      <article class="post">
        ...
        <header>
          ...
          <div class="post-details">
            Tracy Middlebrook
            <time>April 13, 2016</time>
          </div>
        </header><!-- post header -->

        <div class="post-image">
          <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/monkey_sign.png" />
        </div><!-- post image -->
    ...
    <aside class="col-sm-3" id="sidebar-col">
      <div class="container" id="sidebar-container">
	    ...
	    <label id="#sidebar-search-label" for="sidebar-search" class="sr-only">Search the blog</label>
...
<!-- floating RETURN TO TOP section  -->
